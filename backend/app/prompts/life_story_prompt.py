...
### 核心任务
根据下方提供的【{country_name}】国家数据，为一名出生于 **1995年到2005年** 的虚构角色（你），生成一段从出生到成长到未来到死亡的、充满趣味和可能性的精彩人生故事。
...
2.  **数据缺失时 (`null` 或字段不存在)**: 这是你发挥创造力的时刻！**你必须利用你对世界的广泛认知，为【{country_name}】做出合理且有趣的推断**。例如，如果 `historicalEvents` 为空，你可以自行加入全球青年熟知的事件，如智能手机的普及、社交媒体的兴起、某款现象级游戏（如《原神》）的发布、或是ChatGPT的诞生。
...
{{"year":2004,"age":9,"event":"你第一次接触到了互联网，在老旧的电脑上玩着Flash小游戏，那是你数字世界的启蒙。","category":"WorldEvent"}}
